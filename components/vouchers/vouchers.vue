...
<style lang="less" scoped>
  ...
  .send_imag{min-width: 240rpx;display:inline-block;text-align: center;font-size: 24rpx;height: 80rpx;background: url(../../plugins/image/song.png);background-repeat: no-repeat;background-size: 100% 70%;color: #fff;}
</style>
